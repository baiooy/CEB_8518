...
public class InnerListViewOfListView extends ListView {

    ListView parentListView;

    
    public ListView getParentListlView() {
    ...
    public InnerListViewOfListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
