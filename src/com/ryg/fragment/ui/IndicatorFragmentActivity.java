...
import com.ceb.activity.ActInviteRule;
...
public abstract class IndicatorFragmentActivity extends FragmentActivity implements OnPageChangeListener {
    ...
    protected TextView tv_yaoqingrule;
    ...
    private final void initViews() {
        ...
        tv_title.setText(TabInfo.getmTitle());
        tv_yaoqingrule = (TextView) findViewById(R.id.tv_yaoqingrule);
        tv_yaoqingrule.setText(TabInfo.getmRule());
        tv_yaoqingrule.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Intent in1 = new Intent(IndicatorFragmentActivity.this,ActInviteRule.class);
					startActivity(in1);
    ...
    public static class TabInfo implements Parcelable {
        ...
        private static String mRule = null;
        ...
        @SuppressWarnings("rawtypes")
        public TabInfo(int id, String name, Class clazz ,String title ,String rule) {
            this(id, name, 0, clazz,title,rule);
        }

        @SuppressWarnings("rawtypes")
        public TabInfo(int id, String name, boolean hasTips, Class clazz) {
            this(id, name, 0, clazz ,null,null);
            this.hasTips = hasTips;
        }

        @SuppressWarnings("rawtypes")
        public TabInfo(int id, String name, int iconid, Class clazz ,String title ,String rule) {
            super();
		...
		public static String getmRule() {
			return mRule;
		}

		public static void setmRule(String mRule) {
			TabInfo.mRule = mRule;
		}
