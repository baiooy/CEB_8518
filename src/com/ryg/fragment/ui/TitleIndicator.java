...
public class TitleIndicator extends LinearLayout implements View.OnClickListener,
    ...
    private static final int FOOTER_COLOR = R.color.red;//0xFFFFC445;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        path1.rewind();
        path1.moveTo(mPerItemWidth, bottom_y-30f);
        path1.lineTo(mPerItemWidth,30f);
        path1.lineTo(mPerItemWidth+1f, 30f);
        path1.lineTo(mPerItemWidth+1f, bottom_y-30f);

        path1.close();
        
        path2.rewind();
        path2.moveTo(mPerItemWidth*2, bottom_y-30f);
        path2.lineTo(mPerItemWidth*2, 30f);
        path2.lineTo(mPerItemWidth*2+1f, 30f);
        path2.lineTo(mPerItemWidth*2+1f, bottom_y-30f);
