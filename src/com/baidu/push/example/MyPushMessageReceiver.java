...
import com.ceb.activity.ActAppStart;
...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public static int getmErrorCode() {
		return mErrorCode;
	}

	public static void setmErrorCode(int mErrorCode) {
		MyPushMessageReceiver.mErrorCode = mErrorCode;
	}
	...
	public void onBind(Context context, int errorCode, String appid,
		...
		if(userId != null & channelId != null){
			...
			Log.i("userId::channelId", userId+"::"+channelId);
		}
...
//		updateContent(context, responseString);
	...
	public void onMessage(Context context, String message,
		...
		Log.i("userId::channelId", mUserId+"::"+mChannelId);
...
//		String mm = customContentString;
	...
	private void updateContent(Context context, String content) {
		...
		isFirstUse = context.getSharedPreferences("isFirstUse", 0);
		_isFirst = isFirstUse.getBoolean("isFirstUse", true);
