...
public class PlatformListPage extends PlatformListFakeActivity implements View.OnClickListener {
	...
	private void initPageView() {
		...
		llPage.setBackgroundDrawable(new ColorDrawable(0x88888888));
		...
		btnCancel.setTextColor(0xeeeeeeee);
...
//		}else {
		    btnCancel.setBackgroundDrawable(new ColorDrawable(0x66666666));
//		}

		LinearLayout.LayoutParams lpBtn = new LinearLayout.LayoutParams(
				LinearLayout.LayoutParams.MATCH_PARENT, com.mob.tools.utils.R.dipToPx(getContext(), 35));
